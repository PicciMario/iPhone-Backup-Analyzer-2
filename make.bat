pyside-uic main_window.ui > main_window.py

pyside-uic sqlite_widget.ui > sqlite_widget.py
pyside-uic image_widget.ui > image_widget.py
pyside-uic hex_widget.ui > hex_widget.py
